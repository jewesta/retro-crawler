...
public final class MemoryStandardParser implements FactParser<MemoryStandard> {

	@Override
	public RatedFact<MemoryStandard> parse(final String rawValue, final FactParseContext context) {
		if (rawValue == null) {
