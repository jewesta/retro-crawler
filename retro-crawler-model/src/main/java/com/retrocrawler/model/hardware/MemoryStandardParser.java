...
public final class MemoryStandardParser implements EnumFactParser<MemoryStandard> {

	@Override
	public Class<MemoryStandard> enumType() {
		return MemoryStandard.class;
	}

	@Override
	public RatedFact<MemoryStandard> parse(final String rawValue, final ParseContext context) {
		if (rawValue == null) {
