...
public final class Diskette extends MyGear {
	...
	@RetroFact(key = AttributeNames.FLOPPY_DISK_FORM_FACTOR, parser = FloppyDiskFormFactorParser.class, strict = false,
			contextual = true)
	private FloppyDiskFormFactor formFactor;

	@RetroFact(key = AttributeNames.TRACK_DENSITY, parser = TrackDensityParser.class, strict = false, optional = true)
