/**
 * Archive descriptions, source-independent digging, crawl planning, and
 * repositories.
 *
 * <p>
 ...
 * revisiting the configured source. The observed archive remains the source of
 * truth and repository state remains rebuildable.
 */
