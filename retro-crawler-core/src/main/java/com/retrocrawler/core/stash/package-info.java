 ...
 * rebuildable repository representation and the filesystem archive remains the
 * source of truth. This package owns the collector-facing result and is the
 * natural home for its future structured exploration and query capabilities.
 */
